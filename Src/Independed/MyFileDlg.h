...
class MyFileLibAPI TMyFileDlg {
   public:
      ...
      [[nodiscard]] static MyFileDlgUserDlgRet UserLoginDlg(std::string const& strTheme, bool boHasIntegrated, std::optional<std::string> const& strUser, bool boIntegrated);
